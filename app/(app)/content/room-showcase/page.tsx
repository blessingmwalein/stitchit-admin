    ...
    <div className="flex flex-col">
      ...
      <div className="p-6 space-y-2">
        {isLoading ? (
          ...
          rows.map((item, idx) => (
            <div key={item.id} className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 rounded-xl border bg-card">
              ...
              <div className="flex items-center justify-between sm:justify-end gap-2 sm:shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0">
                ...
                <div className="flex items-center gap-2 sm:pl-2 sm:border-l">
